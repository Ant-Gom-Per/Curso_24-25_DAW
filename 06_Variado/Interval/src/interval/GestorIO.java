...
public class GestorIO {
    private static final BufferedReader BUFFER_READER = new BufferedReader(new InputStreamReader(System.in));
    ...
    public String inString() {
        String entrada = null;
        try {
            entrada = BUFFER_READER.readLine();
        } catch (IOException e) {
            this.eixir();
        }
        return entrada;
    ...
    public boolean inBoolean() {
        ...
        if (entrada.equalsIgnoreCase("true") || entrada.equalsIgnoreCase("false")) {
            entradaLogica = Boolean.parseBoolean(entrada);
        } else {
            this.eixir();
        }
